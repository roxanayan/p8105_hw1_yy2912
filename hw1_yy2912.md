...
```
    ...
    ## [1] 1.5213919 0.0000000 0.7761700 0.4731851 0.5968469 0.1895798 1.9471815
    ## [8] 0.0000000
...
```
    ...
    ## [1]  4.5641758 -3.8013990  2.3285099  0.4731851  0.5968469  0.1895798
    ## [7]  3.8943630 -2.5389478
...
![](hw1_yy2912_files/figure-gfm/unnamed-chunk-3-3.png)<!-- --> for
scatterplot \#1, if “x+y\>1” is true, then dots are colored blue; if
“x+y\>1” is false, then dots are colored red. for scatterplot \#2,
color scale changes gradually from dark blue to light blue as both x and
y gradually increases. for scatterplot \#3, if “x+y\>1” is true, then
dots are colored blue; if “x+y\>1” is false, then dots are colored red.
