...
```
    ...
    ## [1] 0.0000000 0.2957836 0.5277521 1.7135881 0.0000000 0.2184343 0.0000000
    ## [8] 0.4730397
...
```
    ...
    ## [1] -3.4123650  0.8873508  1.5832563  1.7135881 -2.4673570  0.2184343
    ## [7] -0.2775192  0.9460795
...
scale changes gradually from dark blue to light blue as both x and y
gradually increases. for scatterplot \#3, if “x+y\>1” is true, then dots
are colored blue; if “x+y\>1” is false, then dots are colored red.
